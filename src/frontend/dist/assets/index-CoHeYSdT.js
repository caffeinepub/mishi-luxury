...
function detectSection(scrollY) {
  ...
  for (const el of sections) {
    ...
    if (mid < window.innerHeight * 0.65) {
      current = el.getAttribute("data-section") ?? "default";
    }
  }
  if (sections.length === 0) {
    if (scrollY < 400) return "hero";
    if (scrollY < 1200) return "jewelry";
    if (scrollY < 2e3) return "products";
    return "legacy";
  }
  return current;
}
function FounderGuides() {
  const { navigate } = useMishi();
  const [visible, setVisible] = reactExports.useState(true);
  const [minimized, setMinimized] = reactExports.useState(false);
  const [bubbleOpen, setBubbleOpen] = reactExports.useState(false);
  const [section, setSection] = reactExports.useState("hero");
  const [posY, setPosY] = reactExports.useState(0);
  const containerRef = reactExports.useRef(null);
  const rafRef = reactExports.useRef(null);
  const targetYRef = reactExports.useRef(0);
  const currentYRef = reactExports.useRef(0);
  reactExports.useEffect(() => {
    const handleScroll = () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              ...
              overflow: "hidden",
              boxShadow: "0 8px 40px rgba(0,0,0,0.7), 0 0 0 1px rgba(212,175,55,0.08), inset 0 1px 0 rgba(212,175,55,0.1)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    ...
                    borderBottom: minimized ? "none" : "1px solid rgba(212,175,55,0.12)"
                  },
                  children: [
                    !minimized && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        style: {
              ...
              !minimized && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 0 0.75rem" }, children: [
                bubbleOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: BUBBLE_MESSAGES[section]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "0.35rem" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "img",
                            {
                              ...
                              style: {
                                ...
                                filter: "drop-shadow(0 4px 16px rgba(0,188,188,0.3)) drop-shadow(0 0 8px rgba(212,175,55,0.2))",
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "img",
                            {
                              ...
                              style: {
                                ...
                                objectFit: "contain",
                                objectPosition: "bottom",
                                filter: "drop-shadow(0 4px 16px rgba(180,100,220,0.35)) drop-shadow(0 0 8px rgba(212,175,55,0.2))",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          style: {
                            ...
                            fontSize: "1.35rem",
                            lineHeight: 1.2,
                            background: "linear-gradient(135deg, #c9a84c 0%, #f5d98b 40%, #d4af37 70%, #e8c84a 100%)",
                            WebkitBackgroundClip: "text",
                            WebkitTextFillColor: "transparent",
                            backgroundClip: "text",
                            filter: "drop-shadow(0 0 8px rgba(212,175,55,0.35))"
                          },
                          children: "Mohit & Shivani"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
              ...
              minimized && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mishi-brand-title", style: { fontSize: "28px" }, children: "Mishi" })
              ]
            }
          ),
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#0a0d16", minHeight: "100vh" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ref: heroRef,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                position: "absolute",
                inset: 0,
                background: "linear-gradient(to bottom, rgba(8,5,18,0.15) 0%, rgba(60,30,100,0.1) 40%, rgba(8,5,18,0.88) 100%)",
                pointerEvents: "none"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                position: "absolute",
                inset: 0,
                background: "radial-gradient(ellipse 88% 82% at 50% 48%, transparent 48%, rgba(6,3,14,0.8) 100%)",
                pointerEvents: "none"
              }
            }
          ),
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    style: {
                      ...
                      lineHeight: 1,
                      background: "linear-gradient(135deg, #c9a84c 0%, #f5d98b 25%, #d4af37 45%, #fceab0 60%, #b8860b 80%, #e8c84a 100%)",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Sterling Silver Ornaments & Royal Ethnic Wear"
                  }
                )
              ]
            }
              ...
              children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  onMouseEnter: (e) => {
                    ...
                    e.currentTarget.style.boxShadow = "0 16px 48px rgba(212,175,55,0.2), 0 0 0 1px rgba(212,175,55,0.3)";
                  },
                  onMouseLeave: (e) => {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          position: "absolute",
                          inset: 0,
                          background: "linear-gradient(to top, rgba(8,5,18,0.96) 0%, rgba(8,5,18,0.3) 55%, transparent 100%)"
                        }
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          ...
          textAlign: "center",
          background: "linear-gradient(90deg, rgba(10,4,24,0), rgba(212,175,55,0.07), rgba(10,4,24,0))",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "p",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#d4af37", fontWeight: 600 }, children: [
                "₹",
                silverRate,
                "/gram"
              ] }),
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "1rem 1.1rem 1.2rem" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", marginTop: "2.5rem" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                ...
                textTransform: "uppercase",
                color: "#0a0d16",
                background: "linear-gradient(135deg, #c9a84c, #f5d98b, #d4af37)",
                border: "none",
                borderRadius: 8,
                cursor: "pointer",
                fontFamily: "Inter, sans-serif",
...
function LegacyPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pt-24 pb-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16 px-6 max-w-6xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: values.map((v, i) => (
        // biome-ignore lint/suspicious/noArrayIndexKey: pre-existing pattern
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-8 text-center", children: [
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-10 w-full max-w-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mt-1", children: "Sign in with your mobile number" })
        ] }),
...
function PageRouter() {
  ...
  if (currentPage === "vault") return /* @__PURE__ */ jsxRuntimeExports.jsx(VaultPage, {});
...
function handleCaffeineLinkEnter(e) {
  e.currentTarget.style.color = "#06b6d4";
}
function handleCaffeineLinkLeave(e) {
  e.currentTarget.style.color = "#2e404a";
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minHeight: "100vh", background: "#080b12" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FounderGuides, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "footer",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Est. 2025 · Mission 2028"
            }
          ),
