const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PrimaryAdminPage-BBoPoXCM.js","assets/shopping-cart-QB85XOdh.js","assets/SecondaryAdminPage-CbRkJ41N.js"])))=>i.map(i=>d[i]);
...
const DEFAULT_SITE_IMAGES = {
  heroUrl: "/assets/generated/mishi-hero-lion-lioness-cliff-guardians.dim_1920x900.jpg",
...
const useMishi = create()(
  persist(
    (set, get) => ({
      ...
      resetProducts: () => set({ products: MOCK_PRODUCTS, siteImages: DEFAULT_SITE_IMAGES }),
    ...
    {
      name: "mishi-store-v2",
      // bumped version to clear old cached broken data
      partialize: (state) => ({
        cart: state.cart,
...
const CartPage = reactExports.lazy(() => __vitePreload(() => import("./CartPage-C724_tzC.js"), true ? [] : void 0));
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./HomePage-CbD8rD3g.js"), true ? [] : void 0));
const InternalControlPage = reactExports.lazy(() => __vitePreload(() => import("./InternalControlPage-tOTVMcW3.js"), true ? [] : void 0));
const LegacyPage = reactExports.lazy(() => __vitePreload(() => import("./LegacyPage-D6OmpoYH.js"), true ? [] : void 0));
const LoginPage = reactExports.lazy(() => __vitePreload(() => import("./LoginPage-TXiDsCuA.js"), true ? [] : void 0));
const OrdersPage = reactExports.lazy(() => __vitePreload(() => import("./OrdersPage-jLpRumIA.js"), true ? [] : void 0));
const PrimaryAdminPage = reactExports.lazy(() => __vitePreload(() => import("./PrimaryAdminPage-BBoPoXCM.js"), true ? __vite__mapDeps([0,1]) : void 0));
const ProductDetailPage = reactExports.lazy(() => __vitePreload(() => import("./ProductDetailPage-DTkIXw0b.js"), true ? [] : void 0));
const SecondaryAdminPage = reactExports.lazy(() => __vitePreload(() => import("./SecondaryAdminPage-CbRkJ41N.js"), true ? __vite__mapDeps([2,1]) : void 0));
const ShopPage = reactExports.lazy(() => __vitePreload(() => import("./ShopPage-CuDa1K0n.js"), true ? [] : void 0));
const VaultPage = reactExports.lazy(() => __vitePreload(() => import("./VaultPage-CaIx4YQL.js"), true ? [] : void 0));
const WishlistPage = reactExports.lazy(() => __vitePreload(() => import("./WishlistPage-BcxCYTBO.js"), true ? [] : void 0));
function PageRouter() {
...
function App() {
  if (typeof window !== "undefined" && window.location.pathname === "/mishi-internal-control") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
