import { r as reactExports, j as jsxRuntimeExports, u as useMishi, a as STAGE_LABELS } from "./index-Q3wwUWeA.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "product_list.panel", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { overflowX: "auto" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { style: s.table, "data-ocid": "product_list.table", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: s.th, children: "Action" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        products.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { "data-ocid": `product_list.item.${i + 1}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: i % 2 === 0 ? s.td : s.tdAlt, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: p.imageUrl || `https://picsum.photos/seed/${p.id}/48/48`,
              alt: p.name,
              style: {
                width: "48px",
                height: "48px",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    onClick: () => {
                      var _a2;
                      return (_a2 = document.getElementById("aj-image-upload")) == null ? void 0 : _a2.click();
                    },
                    children: "📁 Upload Image"
                  }
                ),
                ((_a = form.imageUrl) == null ? void 0 : _a.startsWith("blob:")) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: form.imageUrl,
                    alt: "Preview",
...
function TeamTab({
  ...
  const revokeAccess = (gmail) => {
    setTeamMembers(
      (prev) => prev.map((m) => m.gmail === gmail ? { ...m, isRevoked: true } : m)
    );
  ...
  const restoreAccess = (gmail) => {
    setTeamMembers(
      (prev) => prev.map((m) => m.gmail === gmail ? { ...m, isRevoked: false } : m)
    );
    const member = teamMembers.find((m) => m.gmail === gmail);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { overflowX: "auto", marginBottom: "32px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { style: s.table, "data-ocid": "team.table", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        ...
        teamMembers.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { "data-ocid": `team.row.${i + 1}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: i % 2 === 0 ? s.td : s.tdAlt, children: m.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: i % 2 === 0 ? s.td : s.tdAlt, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: i % 2 === 0 ? s.td : s.tdAlt, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              style: {
                ...
                background: m.role === "manager" ? "rgba(246,173,85,0.12)" : "rgba(113,128,150,0.12)",
                border: `1px solid ${m.role === "manager" ? "#f6ad5555" : "#71809655"}`
              },
              children: m.role === "manager" ? "Manager" : "Viewer"
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "td",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: i % 2 === 0 ? s.td : s.tdAlt, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "6px" }, children: [
...
function InternalControlPage() {
  ...
  const [masterPassword, setMasterPassword] = reactExports.useState("MISHIOWNER2025");
  ...
  if (session && session.role !== "superAdmin" && session.sessionVersion !== sessionVersion) {
    setSession(null);
  }
  if (!session) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: s.root, children: [
      ...
      "div",
      {
        ...
        children: visibleTabs.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              t.label,
              t.id === "team" && session.role === "superAdmin" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    marginLeft: "6px",
    ...
    session.role === "superAdmin" && /* @__PURE__ */ jsxRuntimeExports.jsx(ActivityLogBar, { log: activityLog }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          ...
          activeTab === "orders" && session.role === "superAdmin" && /* @__PURE__ */ jsxRuntimeExports.jsx(ViewOrdersTab, {}),
          activeTab === "team" && session.role === "superAdmin" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            TeamTab,
            {
              teamMembers,
              setTeamMembers,
          ...
          activeTab === "design" && session.role === "superAdmin" && /* @__PURE__ */ jsxRuntimeExports.jsx(WebsiteDesignTab, {}),
          activeTab === "settings" && session.role === "superAdmin" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            SettingsTab,
            {
              emergencyPin,
              setEmergencyPin,
