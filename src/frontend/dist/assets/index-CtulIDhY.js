const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CartPage-BEcpaZPR.js","assets/InvoiceModal-Ddv3bN6-.js","assets/OrdersPage-BMfw82jw.js","assets/PrimaryAdminPage-BX8xO6Xc.js","assets/shopping-cart-I_E7Jko3.js","assets/SecondaryAdminPage-DEhbkiqQ.js"])))=>i.map(i=>d[i]);
...
function convertPrice(priceInINR, currency) {
...
const useMishi = create()(
  persist(
    (set, get) => ({
      ...
      updateSiteImage: (key, value) => set((state) => ({ siteImages: { ...state.siteImages, [key]: value } })),
      ...
      advanceOrderStage: (orderId) => set((state) => ({
        orders: state.orders.map((o2) => {
          if (o2.id !== orderId) return o2;
          const idx = STAGES.indexOf(o2.stage);
          return {
            ...o2,
      ...
      approveOrder: (orderId) => set((state) => ({
        orders: state.orders.map(
          (o2) => o2.id === orderId ? { ...o2, isApproved: true, stage: "artisanCrafting" } : o2
        )
      })),
      // Team management
      ...
      removeTeamMember: (gmail) => set((state) => ({
        teamMembers: state.teamMembers.filter(
          (m) => m.gmail !== gmail || m.isPermanent
        )
      })),
      revokeTeamMember: (gmail) => set((state) => ({
        teamMembers: state.teamMembers.map(
          (m) => m.gmail === gmail ? { ...m, isRevoked: true } : m
        )
      })),
      setMasterPassword: (pw) => set({ masterPassword: pw }),
      restoreTeamMember: (gmail) => set((state) => ({
        teamMembers: state.teamMembers.map(
          (m) => m.gmail === gmail ? { ...m, isRevoked: false } : m
        )
      })),
      updateTeamMemberRole: (gmail, role) => set((state) => ({
        teamMembers: state.teamMembers.map(
          (m) => m.gmail === gmail ? { ...m, role } : m
        )
      })),
      // Review actions
...
function FounderGuides() {
  ...
  const [_mohitError, setMohitError] = reactExports.useState(false);
  const [_shivaniError, setShivaniError] = reactExports.useState(false);
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                bubbleOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "0.3rem" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "0.3rem 0.4rem 0.5rem" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      style: {
                        ...
                        fontSize: "0.95rem",
                        lineHeight: 1.2,
                        background: "linear-gradient(135deg, #7a5200 0%, #b8860b 40%, #d4a017 70%, #8b6200 100%)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            style: {
              ...
              cursor: "pointer",
              boxShadow: "0 6px 24px rgba(184,134,11,0.18), 0 2px 8px rgba(0,0,0,0.06)",
            ...
            onMouseEnter: (e) => {
              ...
              e.currentTarget.style.boxShadow = "0 10px 32px rgba(184,134,11,0.28)";
            },
            onMouseLeave: (e) => {
              e.currentTarget.style.transform = "scale(1)";
              e.currentTarget.style.boxShadow = "0 6px 24px rgba(184,134,11,0.18), 0 2px 8px rgba(0,0,0,0.06)";
            },
            title: "Meet Mohit & Shivani",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", width: 44, height: 52 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: "/assets/images/mohit-guide.png",
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          ...
          boxShadow: "0 10px 30px rgba(0,0,0,0.3), 0 0 40px rgba(180,140,255,0.4)",
          borderRadius: "16px",
          overflow: "hidden"
        },
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "Royal Assistant · Always Available"
                      }
                    )
                  ] })
                ] }),
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          ...
                          background: m.role === "user" ? "linear-gradient(135deg, #D4AF37, #B8960C)" : "rgba(255, 255, 255, 0.92)",
                          border: m.role === "bot" ? "1px solid rgba(100,60,180,0.3)" : "none"
                        },
                        children: m.text
                      }
                    )
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                        ...
                        style: {
                          ...
                          display: "block",
                          background: "none",
                          filter: "drop-shadow(0 0 3px rgba(212,175,55,0.85)) drop-shadow(0 0 1px rgba(180,120,0,0.7))"
                        }
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        style: {
                          fontSize: "16px",
                          lineHeight: 1,
                          filter: "drop-shadow(0 0 2px rgba(60,0,100,0.5)) drop-shadow(0 1px 3px rgba(40,0,80,0.35))"
                        },
                        children: "Mishi"
                      }
                    ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "select",
                  {
                    ...
                    children: CURRENCY_OPTIONS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: c.code, children: c.label }, c.code))
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "select",
                  {
                    ...
                    children: LANGUAGE_OPTIONS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: l.code, children: [
                      l.flag,
                      " ",
                      l.label
                    ] }, l.code))
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { size: 15, color: "#4a3070" }),
...
const CartPage = reactExports.lazy(() => __vitePreload(() => import("./CartPage-BEcpaZPR.js"), true ? __vite__mapDeps([0,1]) : void 0));
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./HomePage-BxqPFYvQ.js"), true ? [] : void 0));
const InternalControlPage = reactExports.lazy(() => __vitePreload(() => import("./InternalControlPage-bVb_o9YP.js"), true ? [] : void 0));
const LegacyPage = reactExports.lazy(() => __vitePreload(() => import("./LegacyPage-BYmEaiaX.js"), true ? [] : void 0));
const LoginPage = reactExports.lazy(() => __vitePreload(() => import("./LoginPage-C3AqceU5.js"), true ? [] : void 0));
const OrdersPage = reactExports.lazy(() => __vitePreload(() => import("./OrdersPage-BMfw82jw.js"), true ? __vite__mapDeps([2,1]) : void 0));
const PrimaryAdminPage = reactExports.lazy(() => __vitePreload(() => import("./PrimaryAdminPage-BX8xO6Xc.js"), true ? __vite__mapDeps([3,4]) : void 0));
const ProductDetailPage = reactExports.lazy(() => __vitePreload(() => import("./ProductDetailPage-DnCVI96-.js"), true ? [] : void 0));
const SecondaryAdminPage = reactExports.lazy(() => __vitePreload(() => import("./SecondaryAdminPage-DEhbkiqQ.js"), true ? __vite__mapDeps([5,4]) : void 0));
const ShopPage = reactExports.lazy(() => __vitePreload(() => import("./ShopPage-Bh1-PA-J.js"), true ? [] : void 0));
const VaultPage = reactExports.lazy(() => __vitePreload(() => import("./VaultPage-DFIRQMHX.js"), true ? [] : void 0));
const WishlistPage = reactExports.lazy(() => __vitePreload(() => import("./WishlistPage-DtfckLpW.js"), true ? [] : void 0));
function isInternalControlRoute() {
...
function PageRouter() {
  ...
  if (currentPage === "internal-control") return /* @__PURE__ */ jsxRuntimeExports.jsx(InternalControlPage, {});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        ...
        alignItems: "center",
        gap: 14,
        boxShadow: "0 8px 32px rgba(60,0,100,0.18), 0 0 20px rgba(212,175,55,0.2)",
        maxWidth: 360,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Add MISHI to Home Screen"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Install for the royal experience"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function App() {
  const { currentPage } = useMishi();
  const isInternalControl = isInternalControlRoute() || currentPage === "internal-control";
  if (isInternalControl) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      reactExports.Suspense,
      {
        fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { minHeight: "100vh", background: "#080b12" } }),
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(InternalControlPage, {})
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minHeight: "100vh", background: "#080b12" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      reactExports.Suspense,
      {
        fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { minHeight: "100vh", background: "#080b12" } }),
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(PageRouter, {})
      }
    ) }),
