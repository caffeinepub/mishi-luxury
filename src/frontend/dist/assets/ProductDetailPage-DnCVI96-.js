import { c as createLucideIcon, o, r as reactExports, v as vt, u as useMishi, j as jsxRuntimeExports, g as getProductPrice, a as convertPrice, S as ShoppingBag, H as Heart } from "./index-CtulIDhY.js";
/**
...
function StarSelector({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 4 }, children: [1, 2, 3, 4, 5].map((star) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      type: "button",
      ...
      children: star <= (hovered || value) ? "⭐" : "☆"
    },
    star
  )) });
}
function StarDisplay({ rating }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: "14px" }, children: [
    "⭐".repeat(rating),
    "☆".repeat(5 - rating)
  ] });
}
...
function ReviewSection({ productId }) {
  ...
  const [mediaBase64, setMediaBase64] = reactExports.useState("");
  const [mediaType, setMediaType] = reactExports.useState("");
  ...
  const handleMediaUpload = (e) => {
    ...
    reader.onload = (ev) => {
      var _a2;
      setMediaBase64((_a2 = ev.target) == null ? void 0 : _a2.result);
  ...
  const handleSubmit = () => {
    ...
    addReview({
      ...
      mediaBase64: mediaBase64 || void 0,
    ...
    setTimeout(() => {
      setSubmitting(false);
      ue.success("Review submitted for approval! ✨");
    }, 500);
  };
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            children: "Royal Reviews"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "royal-divider", style: { marginBottom: "24px" } }),
        approved.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-gray-400 text-sm mb-6",
            "data-ocid": "reviews.empty_state",
            children: "Be the first to share your royal experience!"
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: approved.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "glass-card",
                style: { padding: "16px" },
                ...
                children: [
                    ...
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(StarDisplay, { rating: r.rating }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              className: "text-gray-400",
                              style: { fontSize: "12px", marginTop: 4 },
                              children: maskPhone(r.customerPhone)
                            }
                          )
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", style: { fontSize: "11px" }, children: new Date(r.submittedAt).toLocaleDateString("en-IN") })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  r.mediaBase64 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: r.mediaBase64,
                      alt: "Customer review",
        ...
        isLoggedIn ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "reviews.panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
            {
              style: {
              ...
              children: "Leave Your Royal Review"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 uppercase tracking-widest mb-2", children: "Your Rating" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 uppercase tracking-widest mb-2", children: "Photo (Optional)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                  ...
                  children: [
                    ...
                    mediaBase64 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                        src: mediaBase64,
                        alt: "preview",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: submitting ? "Submitting..." : "Submit Royal Review ✦"
              }
            )
          ] })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-6", "data-ocid": "reviews.login_state", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mb-4 text-sm", children: "Login to leave a review for this piece" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
function ProductDetailPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pt-24 px-6 pb-20 max-w-6xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center", children: [
        ...
        p.category === "silver" && p.silverWeight && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4 mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-100", children: convertPrice(p.basePrice || 0, currency) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-400", children: [
                p.silverWeight,
                "g × ",
                convertPrice(silverRate, currency),
                " ",
                "(Live Rate)"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-100", children: convertPrice(p.silverWeight * silverRate, currency) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "royal-divider" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text font-semibold", children: "Total" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text font-bold text-lg", children: convertPrice(priceINR, currency) })
            ] })
          ] })
        ] }),
        p.category === "ethnic" && p.sizes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: p.sizes.map((sz) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setSize(sz.size),
              disabled: sz.stock === 0,
              className: `px-4 py-2 text-sm border rounded-md transition-all ${size === sz.size ? "border-yellow-400 text-yellow-400 bg-yellow-400/10" : sz.stock === 0 ? "border-gray-700 text-gray-600 cursor-not-allowed" : "border-gray-600 text-gray-300 hover:border-yellow-400 hover:text-yellow-400"}`,
              children: sz.size
            },
            sz.size
          )) })
        ] }),
        p.category !== "ethnic" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl gold-text font-bold mb-6", children: convertPrice(priceINR, currency) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
          ...
          p.category === "ethnic" && p.sizes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl gold-text font-bold", children: convertPrice(priceINR, currency) })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewSection, { productId: p.id })
  ] });
}
export {
