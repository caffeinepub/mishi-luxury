...
const CirclePlus = createLucideIcon("circle-plus", __iconNode$e);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "MISHI Butler"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "Royal Assistant · Always Available" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-3 flex flex-col gap-2", children: [
            msgs.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `px-3 py-2 rounded-xl text-sm max-w-[85%] ${m.role === "user" ? "text-black" : "text-amber-100"}`,
                    style: {
                      background: m.role === "user" ? "linear-gradient(135deg, #D4AF37, #B8960C)" : "rgba(75,0,130,0.4)",
                      border: m.role === "bot" ? "1px solid rgba(212,175,55,0.3)" : "none",
                      lineHeight: 1.5
                    },
                    children: m.text
                  }
...
const MOCK_PRODUCTS = [
  {
    ...
    category: "silver",
    description: "Handcrafted Sterling Silver Chandbali earrings adorned with intricate filigree work. Each piece reflects generations of artisan mastery and royal heritage.",
    price: 6260,
    silverWeight: 8,
    basePrice: 4500,
    sizes: [],
  ...
  },
  {
    ...
    category: "silver",
    description: "Majestic Sterling Silver necklace set with matching earrings. Inspired by Mughal court jewellery, crafted for modern royalty.",
    price: 11375,
    silverWeight: 25,
    basePrice: 8e3,
    sizes: [],
  ...
  },
  {
    ...
    category: "ethnic",
    description: "Pure Silk Banarasi Lehenga with gold zari work. A timeless masterpiece woven with centuries of weaving heritage from Varanasi.",
    price: 35e3,
    sizes: [
      { size: "XS", stock: 2 },
      { size: "S", stock: 4 },
  ...
  },
  {
    ...
    category: "ethnic",
    description: "Regal Silk Sherwani with intricate embroidery, paired with churidar and dupatta. The epitome of groom royalty.",
    price: 28e3,
    sizes: [
      { size: "36", stock: 3 },
      { size: "38", stock: 4 },
  ...
  },
  {
    ...
    category: "silver",
    description: "Solid Sterling Silver Kada with hand-engraved royal motifs. Worn by royals for centuries, now crafted for you.",
    price: 7375,
    silverWeight: 30,
    basePrice: 4500,
    sizes: [],
  ...
  },
  {
    ...
    category: "ethnic",
    description: "Floor-length Anarkali in royal blue with gold embroidery. The dress of queens, reimagined for 2025.",
    price: 18500,
    sizes: [
      { size: "XS", stock: 2 },
      { size: "S", stock: 3 },
...
const useMishi = create()(
  persist(
    (set, get) => ({
      ...
      addToCart: (productId, quantity, selectedSize) => set((state) => {
        ...
        if (existing) {
          return {
            cart: state.cart.map(
              (i) => i.productId === productId && i.selectedSize === selectedSize ? { ...i, quantity: i.quantity + quantity } : i
            )
          };
        }
        return {
      ...
      updateCartQty: (productId, quantity, selectedSize) => set((state) => ({
        cart: quantity <= 0 ? state.cart.filter(
          (i) => !(i.productId === productId && i.selectedSize === selectedSize)
        ) : state.cart.map(
          (i) => i.productId === productId && i.selectedSize === selectedSize ? { ...i, quantity } : i
        )
      })),
      clearCart: () => set({ cart: [] }),
      placeOrder: (shippingAddress) => {
        ...
        cart.forEach((ci) => {
          ...
          if (p) {
            const price = p.category === "silver" && p.silverWeight ? (p.basePrice || p.price) + p.silverWeight * silverRate : p.price;
      ...
      login: (phone) => set({ isLoggedIn: true, phone, adminLevel: "customer" }),
      loginAsAdmin: (level) => set({
        isLoggedIn: true,
      ...
      advanceOrderStage: (orderId) => set((state) => ({
        orders: state.orders.map((o) => {
          if (o.id !== orderId) return o;
          const idx = STAGES$1.indexOf(o.stage);
          return {
            ...o,
            stage: STAGES$1[Math.min(idx + 1, STAGES$1.length - 1)]
          };
        })
      })),
      approveOrder: (orderId) => set((state) => ({
        orders: state.orders.map(
          (o) => o.id === orderId ? { ...o, isApproved: true, stage: "artisanCrafting" } : o
        )
      }))
    }),
    { name: "mishi-store" }
...
function getProductPrice(p, silverRate) {
...
function Navbar() {
  ...
  const link = (page, label) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      onClick: () => {
        navigate(page);
      ...
      className: `transition-all duration-200 hover:text-yellow-400 text-sm tracking-widest uppercase font-medium ${currentPage === page ? "text-yellow-400" : "text-amber-100"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Heart,
                    {
                      ...
                      color: wishlist.length > 0 ? "#D4AF37" : void 0
                    }
                  ),
                  wishlist.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
            ...
            isLoggedIn ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { size: 14, className: "inline mr-1" }),
                  "Login"
                ]
              }
            ),
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              adminLevel === "secondary" && link("admin-secondary", "Shrimati Ji Dashboard")
            ]
          }
        )
      ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pt-24 px-6 pb-20 max-w-5xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-2 space-y-4", children: enriched.map(
        (item, i) => item.product && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4 flex gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 mb-4", children: [
            enriched.map(
              (item, i) => item.product && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex items-center justify-center overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(to bottom, rgba(10,10,15,0.3) 0%, rgba(10,10,15,0.6) 60%, rgba(10,10,15,1) 100%)"
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-6 max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-[0.4em] text-yellow-400 mb-4 uppercase", children: "Est. 2025 · Mission 2028" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h1",
          {
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "Where Royalty Meets Craftsmanship"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "royal-divider w-64 mx-auto" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 text-sm tracking-wide mb-10 max-w-xl mx-auto", children: "Sterling Silver Ornaments & Royal Ethnic Wear — crafted for those who wear their legacy" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-60", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 tracking-widest uppercase", children: "Scroll" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-12 bg-gradient-to-b from-yellow-400 to-transparent" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-20 px-6 max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs tracking-[0.4em] text-yellow-400 uppercase mb-3", children: "Our Collections" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          style: {
        ...
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 p-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs tracking-widest text-yellow-400 uppercase", children: c.tag }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm", children: c.sub }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 text-yellow-400 text-sm tracking-widest uppercase flex items-center gap-2 group-hover:gap-4 transition-all", children: [
                "Discover ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm tracking-widest", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-400 uppercase text-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs ml-3", children: "(Reflected in all Sterling Silver prices)" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-20 px-6 max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs tracking-[0.4em] text-yellow-400 uppercase mb-3", children: "Handpicked" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: featured.map((p) => {
          ...
          "div",
          {
            ...
            children: [
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: wished ? "❤️" : "🤍" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs tracking-widest text-yellow-400 uppercase", children: p.category === "silver" ? "Sterling Silver" : "Ethnic Wear" })
                      }
                    )
                  ]
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
                ...
                p.category === "silver" && p.silverWeight && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500 mb-1", children: [
                  p.silverWeight,
                  "g silver · Rate ₹",
                  silverRate,
                  "/g"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "gold-text font-semibold mb-3", children: [
                  "₹",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, rgba(75,0,130,0.15), rgba(10,10,15,0), rgba(212,175,55,0.05))"
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-[0.4em] text-yellow-400 uppercase mb-4", children: "A Story of Vision" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: '"Born from an unwavering dream, MISHI is more than a brand — it is a dynasty in the making. Founded on the twin pillars of Purity and Heritage, we craft each piece as if it were destined for a palace."'
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
...
function LegacyPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pt-24 pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-32 px-6 text-center overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "absolute inset-0",
          style: {
            background: "radial-gradient(ellipse at center, rgba(75,0,130,0.3) 0%, rgba(10,10,15,0) 70%)"
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-3xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-[0.4em] text-yellow-400 uppercase mb-4", children: "Est. 2025 · Mission 2028" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h1",
          {
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: '"Born from an unwavering dream, MISHI is more than a brand — it is a dynasty in the making."'
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-6 max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-10 md:p-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-[0.4em] text-yellow-400 uppercase mb-6", children: "Our Story" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "It began not with a business plan, but with a belief. A visionary couple, united by love and an audacious dream — to create a luxury brand that would one day grace the wrists, necks, and hearts of people across the globe." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "MISHI was conceived on the twin pillars of",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text font-semibold", children: "Purity" }),
              " and",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text font-semibold", children: "Heritage" }),
              ". Purity in the form of 925 hallmarked Sterling Silver, crafted by the finest artisans. Heritage in the form of Royal Ethnic Wear — each weave telling a story older than any empire."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "We do not merely sell jewellery or clothing. We offer you a piece of history, a fragment of royalty, a connection to something far greater than the transient. Every MISHI creation is a testament to",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text", children: "Craftsmanship" }),
              ",",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text", children: "Vision" }),
              ", and",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text", children: "Royal Standards" }),
              " that refuse to bend."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Mission 2028 is our covenant with the world. By 2028, MISHI will stand as a global luxury empire — not built overnight, but forged over years of unwavering dedication, one perfect piece at a time." })
          ]
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-6 max-w-3xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "glass-card p-10 text-center relative",
        style: {
          background: "linear-gradient(135deg, rgba(75,0,130,0.2), rgba(10,10,15,0.8))"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-6", children: "🦁" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-[0.4em] text-yellow-400 uppercase mb-6", children: "Founder's Message" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "blockquote",
            {
              style: {
              ...
              children: '"We did not build MISHI to compete — we built it to transcend. Every piece we create carries our legacy, our love, and our promise of Royal Standards that will outlast trends, outlast time. This is not a brand. This is our heritage — passed on to you."'
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "royal-divider w-32 mx-auto mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: { fontFamily: "Playfair Display, serif" },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm tracking-widest uppercase", children: "MISHI Luxury · Est. 2025" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16 px-6 max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-[0.4em] text-yellow-400 uppercase mb-3 text-center", children: "The Journey" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs tracking-widest text-yellow-400 uppercase", children: item.year }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "h3",
                      {
                        style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-black font-bold text-xs", children: item.year.slice(2) })
                }
              ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16 px-6 max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs tracking-[0.4em] text-yellow-400 uppercase mb-3 text-center", children: "What We Stand For" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: values.map((v, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-8 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-4", children: v.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h3",
          {
            style: {
...
function LoginPage() {
  ...
  const [adminCode, setAdminCode] = reactExports.useState("");
  const sendOtp = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        background: "radial-gradient(ellipse at center, rgba(75,0,130,0.2) 0%, rgba(10,10,15,0) 60%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-10 w-full max-w-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
              ...
              children: adminMode ? "Admin Access" : "Royal Login"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mt-1", children: adminMode ? "Enter your access code" : "Sign in with your mobile number" })
        ] }),
        !adminMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
          step === "phone" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-gray-400 uppercase tracking-widest block mb-2", children: "Mobile Number" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex items-center gap-2",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { size: 18, className: "text-yellow-400" }),
          ...
          step === "otp" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-gray-400 uppercase tracking-widest block mb-2", children: "Enter OTP" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-gray-400 uppercase tracking-widest block mb-2", children: "Access Code" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "flex items-center gap-2",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { size: 18, className: "text-yellow-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      value: adminCode,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600 text-center", children: "Primary: MISHI2028 · Secondary (Shrimati Ji): SHRIMATIJI" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: adminMode ? "← Customer Login" : "Admin Access →"
          }
        )
      ] })
    }
...
function PrimaryAdminPage() {
  ...
  if (adminLevel !== "primary")
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen pt-24 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-10 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "text-yellow-400 mx-auto mb-3", size: 40 }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pt-24 px-6 pb-20 max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "text-yellow-400", size: 32 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h1",
          {
    ...
    tab === "analytics" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      ].map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-text mb-3", children: stat.icon }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-400 text-sm", children: [
          "Total Products:",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text", children: products.length }),
          "  ·  Active:",
          " ",
          ...
          " ·  Silver Items:",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-400", children: products.filter((p) => p.category === "silver").length }),
          " ",
          " ·  Ethnic Wear:",
          " ",
    ...
    tab === "orders" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      [...orders].reverse().map((o) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-between items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-amber-100 font-semibold", children: [
              "Order #",
              o.id
            ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-400 mr-2 self-center", children: [
            "Stage:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text", children: STAGE_LABELS[o.stage] })
          ] }),
    ...
    tab === "products" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: products.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4 flex gap-4 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-100 font-medium", children: p.name }),
    ...
    tab === "add" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-8 max-w-xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-gray-400 uppercase tracking-widest block mb-1", children: f.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-gray-400 uppercase tracking-widest block mb-1", children: "Category" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
        ...
        newProduct.category === "silver" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-gray-400 uppercase tracking-widest block mb-1", children: "Silver Weight (grams)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
        ...
        newProduct.category === "ethnic" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-gray-400 uppercase tracking-widest block mb-1", children: "Sizes (comma-separated)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              value: sizes,
...
function SecondaryAdminPage() {
  ...
  if (adminLevel !== "secondary" && adminLevel !== "primary")
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen pt-24 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-10 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "text-yellow-400 mx-auto mb-3", size: 40 }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen pt-24 px-6 pb-20 max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "text-yellow-400", size: 28 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h1",
          {
    ...
    ].map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5 flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-text", children: stat.icon }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs uppercase tracking-widest", children: stat.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
    ...
    tab === "orders" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      [...orders].reverse().map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass-card p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-between gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "gold-text font-bold", children: [
            "₹",
            o.totalAmount.toLocaleString("en-IN")
          ] }),
          !o.isApproved ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    tab === "products" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: products.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4 flex gap-4 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-100", children: p.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400", children: [
          p.category === "silver" ? "Sterling Silver" : "Ethnic Wear",
          " ",
          " ·  Stock: ",
    ...
    tab === "rate" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-8 max-w-md", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-gray-400 uppercase tracking-widest block mb-2", children: "Rate per gram (₹)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          value: rate,
...
function PageRouter() {
  ...
  if (currentPage === "home") return /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {});
  if (currentPage === "shop") return /* @__PURE__ */ jsxRuntimeExports.jsx(ShopPage, {});
  if (currentPage.startsWith("product-")) {
    const id = Number.parseInt(currentPage.split("-")[1]);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ProductDetailPage, { productId: id });
  }
  if (currentPage === "cart") return /* @__PURE__ */ jsxRuntimeExports.jsx(CartPage, {});
  if (currentPage === "orders") return /* @__PURE__ */ jsxRuntimeExports.jsx(OrdersPage, {});
  if (currentPage === "wishlist") return /* @__PURE__ */ jsxRuntimeExports.jsx(WishlistPage, {});
  if (currentPage === "legacy") return /* @__PURE__ */ jsxRuntimeExports.jsx(LegacyPage, {});
  if (currentPage === "login") return /* @__PURE__ */ jsxRuntimeExports.jsx(LoginPage, {});
  if (currentPage === "admin") return /* @__PURE__ */ jsxRuntimeExports.jsx(PrimaryAdminPage, {});
  if (currentPage === "admin-secondary") return /* @__PURE__ */ jsxRuntimeExports.jsx(SecondaryAdminPage, {});
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minHeight: "100vh", background: "#0a0a0f" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PageRouter, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MishiButler, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "footer",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs tracking-widest uppercase mb-4", children: "Where Royalty Meets Craftsmanship · Est. 2025 · Mission 2028" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "royal-divider w-48 mx-auto mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-xs", children: "Sterling Silver Ornaments & Royal Ethnic Wear  ·  © 2025 MISHI Luxury. All rights reserved." })
        ]
      }
    )
  ] });
